...
hi LineNr guifg=#827979 guibg=black ctermfg=239 ctermbg=0
...
hi ErrorMsg guifg=white guibg=#FF0000 gui=bold ctermfg=white ctermbg=203 cterm=bold
hi WarningMsg guifg=white guibg=#FF0000 gui=bold ctermfg=white ctermbg=203 cterm=bold
...
if version >= 700 " Vim 7.x specific colors
 ...
 hi Search guifg=#000000 guibg=#FFF348 ctermfg=0 ctermbg=195 
endif
...
hi Identifier guifg=#6966FF ctermfg=189 
hi Function guifg=#FF9830 ctermfg=223 
hi Type guifg=#FFFF54 ctermfg=229 
